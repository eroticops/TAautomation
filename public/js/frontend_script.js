function myCreateFunctionTravelling() {
  ...
  cell2.innerHTML =
    ...
    '" maxlength="30"></input>';
  cell3.innerHTML =
    '<input name="From' + (totalRows + 1) + '" maxlength="30"></input>';
  cell4.innerHTML =
    '<input name="To' + (totalRows + 1) + '" maxlength="30"></input>';
  cell5.innerHTML =
    '<input name="Mode' + (totalRows + 1) + '"maxlength="30"></input>';
  cell6.innerHTML =
    '<input name="Class' + (totalRows + 1) + '" maxlength="30"></input>';
  cell7.innerHTML =
    '<input type="number" name="Fare' +
    (totalRows + 1) +
    '" maxlength="30"></input>';
  cell8.innerHTML =
    '<input type="number" name="Convenience' +
    (totalRows + 1) +
    '" maxlength="30"></input>';
  cell9.innerHTML =
    '<input type="number" name="Food_Loddging' +
    (totalRows + 1) +
    '" maxlength="30"></input>';
  cell10.innerHTML =
    '<input type="number" name="Incidental' +
    (totalRows + 1) +
    '" maxlength="30"></input>';
  cell11.innerHTML =
